        ...
        <PageLayout>
          <Card className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-4 max-w-2xl mx-auto">
              Connect with the right opportunities or find the perfect talent
              for your organization. Choose your role below to get started.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto mt-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Access a pool of qualified candidates and find the perfect
                  match for your organization&apos;s needs
                </p>
              </Link>
            </div>
          </Card>
